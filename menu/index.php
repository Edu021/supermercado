            ...
            <a class="navbar-brand" href="http://3.21.113.127/supermercado/efetuar_logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i></i></a>
              ...
              <div class="d-flex">
                ...
                <div class="container-xs cards-menu">
                  <div class="row mb-3">
                    <div class="col" onclick="location.href='http://3.21.113.127/supermercado/cadastro_mercadorias'">
                    ...
                    <div class="col" onclick="location.href='http://3.21.113.127/supermercado/listar_mercadorias'">
                      <div class="card" style="width: 13rem;">
                    ...
                    <div class="col" onclick="location.href='http://3.21.113.127/supermercado/cadastro_usuario'">
                        <div class="card" style="width: 13rem;">
                  ...
                  <div class="row mb-3">
                    <div class="col" onclick="location.href='http://3.21.113.127/supermercado/consultar_usuario'">
                      <div class="card" style="width: 13rem;">
                    ...
                    <div class="col" onclick="location.href='http://3.21.113.127/supermercado/cadastro_fornecedor'">
                      <div class="card" style="width: 13rem;">
                    ...
                    <div class="col" onclick="location.href='http://3.21.113.127/supermercado/consultar_fornecedor'">
                        <div class="card" style="width: 13rem;">
                  ...
                  <div class="row mb-3">
                    <div class="col" onclick="location.href='http://3.21.113.127/supermercado/cadastro_cliente'">
                      <div class="card" style="width: 13rem;">
                    ...
                    <div class="col" onclick="location.href='http://3.21.113.127/supermercado/listar_clientes'">
                      <div class="card" style="width: 13rem;">
                     ...
                     <div class="col" onclick="location.href='http://3.21.113.127/supermercado/cadastro_pedido_fornecedor'">
                        <div class="card" style="width: 13rem;">
                  ...
                  <div class="row mb-3">
                    <div class="col" onclick="location.href='http://3.21.113.127/supermercado/cadastro_pedido_cliente'">
                      <div class="card" style="width: 13rem;">
                    ...
                    <div class="col"  onclick="location.href='http://3.21.113.127/supermercado/caixa'">
                      <div class="card" style="width: 13rem;">
                    ...
                    <div class="col"  onclick="location.href='http://3.21.113.127/supermercado/listar_clientes_pedidos'">
                        <div class="card" style="width: 13rem;">
                  ...
                  <div class="row mb-3">
                    <div class="col" onclick="location.href='http://3.21.113.127/supermercado/listar_fornecedor_pedidos'">
                      <div class="card" style="width: 13rem;">
                    ...
                    <div class="col"  onclick="location.href='http://3.21.113.127/supermercado/efetuar_logout.php'">
                      <div class="card" style="width: 13rem;">
