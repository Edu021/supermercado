  ...
  if(!isset($_SESSION['user']) && !isset($_SESSION['permissao'])) {
    ...
    if($_SESSION['permissao'] === 'administrador' || 'almoxarife') { ?>
        ...
        <body>
            ...
            <!-- INPUT GROUP -->
            <form method="POST" action="http://3.21.113.127/supermercado/api/api_fornecedores.php">
            ...
            <script src="http://3.21.113.127/supermercado/scripts/cadastro_fornecedor.js"></script>
