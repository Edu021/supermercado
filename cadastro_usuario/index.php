    ...
    if($_SESSION['permissao'] === 'administrador') { ?>
      ...
      <html lang="pt-br">
        ...
        <nav class="navbar navbar-dark bg-dark">
            ...
            <!-- INPUT GROUP -->
            <form action="http://3.21.113.127/supermercado/api/api_usuarios.php" method="post" id="form1">
          ...
          <script src="http://3.21.113.127/supermercado/scripts/cadastro_usuario.js"></script>
        </body>
      </html>
    <?php } else {
