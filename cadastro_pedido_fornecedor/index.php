  ...
  if(!isset($_SESSION['user']) && !isset($_SESSION['permissao'])) {
    ...
    if($_SESSION['permissao'] === 'administrador' || 'almoxarife') { ?>
        ...
        <head>
            ...
            <title>Novo pedido de fornecedor</title>
        </head>
        ...
        <body>
            ...
            <h1 class="text-center">CADASTRAR PEDIDO DE FORNECEDOR</h1>

            <!-- INPUT GROUP -->
            <form action="http://3.21.113.127/supermercado/api/api_pedidos_compra.php" method="POST">
              ...
              <?php
                    ...
                    <div class="row g-2">
                        <div class="form-floating mb-3 col-md">
                            <input type="text" name="cnpj_fornecedor" class="form-control" id="floatingInput" placeholder="CNPJ do Fornecedor" required>
                            <label for="floatingInput">CNPJ do Fornecedor</label>
                        </div>
            ...
            <script src="http://3.21.113.127/supermercado/scripts/cadastro_pedido_fornecedor.js"></script>
