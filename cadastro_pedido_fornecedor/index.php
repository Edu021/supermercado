  ...
  if(!isset($_SESSION['user']) && !isset($_SESSION['permissao'])) {
    ...
    if($_SESSION['permissao'] === 'administrador' || 'almoxarife') { ?>
        ...
        <body>
            ...
            <!-- INPUT GROUP -->
            <form action="http://localhost/supermercado/api/api_pedidos_compra.php" method="POST">
            ...
            <script src="http://localhost/supermercado/scripts/cadastro_pedido_fornecedor.js"></script>
