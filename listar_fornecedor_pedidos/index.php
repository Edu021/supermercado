...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="d-flex form-filtrar-pedido">
      <input type="search" onkeyup="searchFields()" id="barraDePesquisaClientesEPedidos" class="form-control form-filtrar-prod-campos" style="width: 20%;" placeholder="Pesquisar">
    ...
    <br>
    <!-- TABLE -->
    <table class="table table-responsive table-hover" id="tabela-pedido">
    <!-- THEAD -->
    ...
    <script src="http://3.21.113.127/supermercado/scripts/listar_fornecedor_pedidos.js"></script>
